...
- **Distribución por Mecanismo de Muerte**: Gráfico *treemap* que muestra cuántos casos se asocian a cada medio (p. ej., arma de fuego reglamentaria, otro tipo de arma, etc.).  
